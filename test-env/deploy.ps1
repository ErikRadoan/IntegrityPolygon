<#
.SYNOPSIS
    Deploy and test IntegrityPolygon in Docker (Velocity + Paper)
...
function Invoke-Mvn {
    ...
    cmd /c "set ""JAVA_HOME=C:\Program Files\Java\jdk-21"" && cd /d ""$WorkDir"" && ""$MVN"" $MvnArgs > ""$logFile"" 2>&1"
...
function Build-All {
    ...
    # Modules
    foreach ($mod in @("anti-bot", "account-protection", "identity-enforcement", "geo-filtering", "profiler", "spike-detector")) {
